...
//       <div className="flex items-center justify-center min-h-screen bg-[#FEFAF6] p-6">
//         <div className="w-full max-w-4xl">
//           {/* Header Section */}
//           <div className="text-center mb-12">
//             <h1 className="text-4xl font-extrabold text-[#47464C] mt-20">Get a Quote</h1>
//             <h2 className="text-lg text-[#47464C]">Our team will contact you shortly</h2>
//           </div>
  
//           {/* Contact Form */}
//           <form className="space-y-6 p-8 bg-white rounded-lg shadow-lg">
//             <h2 className="text-3xl font-extrabold text-[#47464C] text-center mb-8">Contact Us</h2>
  
//             <div className="grid gap-6 md:grid-cols-2">
//               {/* First Name */}
//               <div>
//                 <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-[#47464C]">First Name</label>
//                 <div className="flex items-center bg-[#F9FAFB] border border-[#B4C424] rounded-lg p-3">
//                   <FaUserAlt className="text-[#47464C] mr-2" />
//                   <input
//                     type="text"
//                     id="first_name"
...
//               {/* Last Name */}
//               <div>
//                 <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-[#47464C]">Last Name</label>
//                 <div className="flex items-center bg-[#F9FAFB] border border-[#B4C424] rounded-lg p-3">
//                   <FaUserAlt className="text-[#47464C] mr-2" />
//                   <input
//                     type="text"
...
//             {/* Phone Number */}
//             <div>
//               <label htmlFor="phone" className="block mb-2 text-sm font-medium text-[#47464C]">Phone Number</label>
//               <div className="flex items-center bg-[#F9FAFB] border border-[#B4C424] rounded-lg p-3">
//                 <FaPhoneAlt className="text-[#47464C] mr-2" />
//                 <input
//                   type="tel"
...
//             {/* Email Address */}
//             <div>
//               <label htmlFor="email" className="block mb-2 text-sm font-medium text-[#47464C]">Email Address</label>
//               <div className="flex items-center bg-[#F9FAFB] border border-[#B4C424] rounded-lg p-3">
//                 <FaEnvelope className="text-[#47464C] mr-2" />
//                 <input
//                   type="email"
...
//             {/* Message */}
//             <div>
//               <label htmlFor="message" className="block mb-2 text-sm font-medium text-[#47464C]">Message</label>
//               <div className="flex items-start bg-[#F9FAFB] border border-[#B4C424] rounded-lg p-3">
//                 <FaRegComment className="text-[#47464C] mr-2 mt-1" />
//                 <textarea
//                   id="message"
